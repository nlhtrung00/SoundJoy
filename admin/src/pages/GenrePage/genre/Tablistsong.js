                                        ...
                                        {listSongs.map((song, index) => {
                                            return (
                                                <StyledTableRow key={song._id} onClick={() => history.push(`/songs/${song._id}`)}>
                                                    ...
                                                    <StyledTableCell sx={{ width: '250px' }}>
                                                        {
                                                            (musicians && musicians.length> 0) ? song.musician.map((item,index) => (
                                                                musicians.find(musician => musician._id === item) ? 
                                                                ((index < song.musician.length - 1) ?
                                                                musicians.find(musician => musician._id === item).name +", " : musicians.find(musician => musician._id === item).name )
